...
class TestValidatorStringLength:
    ...
    def test_validate_string_length_valid(self):
        ...
        result = Validator.validate_string_length("test", min_length=1, max_length=10, field_name="field")
        assert result == "test"
    ...
    def test_validate_string_length_exact_length(self):
        ...
        result = Validator.validate_string_length("test", min_length=4, max_length=4, field_name="field")
        assert result == "test"
...
class TestValidatorNumberRange:
    ...
    def test_validate_number_range_float_valid(self):
        ...
        result = Validator.validate_number_range(5.5, min_value=1.0, max_value=10.0, field_name="field")
        assert result == 5.5
...
class TestValidatorRegex:
    ...
    def test_validate_regex_with_flags(self):
        ...
        result = Validator.validate_regex("ABC123", r"^[a-z]+\d+$", field_name="field", flags=re.IGNORECASE)
        assert result == "ABC123"
...
class TestValidatorDictStructure:
    ...
    def test_validate_dict_structure_custom_field_name(self):
        ...
        assert field_name not in str(exc_info.value)  # El error es sobre el campo específico, no el contenedor
...
class TestValidatorPydanticModel:
    ...
    def test_validate_pydantic_model_valid(self, sample_pydantic_model):
        ...
        result = Validator.validate_pydantic_model(data, sample_pydantic_model, field_name="model_field")
...
class TestValidatorGlobalInstance:
    ...
    def test_validator_chain_validation(self):
        ...
        Validator.validate_string_length(data["username"], min_length=3, max_length=20, field_name="username")
...
class TestValidatorIntegration:
    ...
    def test_complete_user_validation_workflow(self, sample_pydantic_model):
        ...
        Validator.validate_string_length(username, min_length=3, max_length=20, field_name="username")
        ...
        user_model = Validator.validate_pydantic_model(
            ...
            field_name="user_model"
        )
        
        # Verificaciones finales
        assert user_model.name == "john_doe123"
        assert user_model.email == "John.Doe@example.com"  # Email normalizado (solo dominio en minúsculas)
