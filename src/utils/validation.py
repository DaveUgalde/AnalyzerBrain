...
class Validator(Generic[T]):
    ...
    def validate_not_empty(
        value: Optional[str | Collection[Any]], field_name: str = "value"
    ) -> str | Collection[Any]:
    ...
    @staticmethod
    def validate_regex(value: str, pattern: str, field_name: str = "value", flags: int = 0) -> str:
    ...
    @staticmethod
    def validate_json(
        json_str: str, schema: Optional[Dict[str, Any]] = None, field_name: str = "json"
    ) -> Dict[str, Any]:
    ...
    def validate_dict_structure(
        data: Dict[str, Any], structure: Dict[str, Any], field_name: str = "data"
    ) -> Dict[str, Any]:
    ...
    def validate_pydantic_model(
        data: Dict[str, Any], model_class: type[BaseModel], field_name: str = "data"
    ) -> BaseModel:
